...
function injectReactDocgenInfo(path, state, code, t) {
  ...
  var _state$opts = state.opts,
      ...
      factoryHandlersOpt = _state$opts.factoryHandlers,
      DOC_GEN_COLLECTION_NAME = _state$opts.DOC_GEN_COLLECTION_NAME,
      opts = _objectWithoutProperties(_state$opts, ["resolver", "handlers", "factoryHandlers", "DOC_GEN_COLLECTION_NAME"]);
    ...
    if (factoryHandlersOpt) {
      factoryHandlersOpt.forEach(function (factoryHandler) {
        if (typeof factoryHandler === 'function') {
          var handler = factoryHandler(path, state, code, t);
